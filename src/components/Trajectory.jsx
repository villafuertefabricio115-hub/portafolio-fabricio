...
export default function Trajectory() {
  const milestones = [
    ...
    },
    {
      ...
      body: "Estoy consolidando mi perfil como desarrollador con interés en frontend, productos web y proyectos que aporten valor a personas, instituciones o procesos.",
    },
  ];
  ...
  const projects = [
    {
      title: "CitaMed",
      description: "Sistema de gestión de citas médicas pensado como base para una plataforma institucional de seguimiento médico y apoyo estudiantil.",
      image: "/src/img/citamed_baner.png",
      pdf: "/Documentacion_CitaMed.pdf",
    },
    {
      title: "Turno Nocturno",
      description: "Videojuego indie de plataformas y acción en 2D, desarrollado con Godot y pensado para una experiencia rápida en contexto de feria institucional.",
      image: "/src/img/TN_baner.png",
      pdf: "/Documentacion_Game.pdf",
    },
  ];
            ...
            <div className="rounded-2xl border border-[#2a2a2a] bg-[#121212] p-6 shadow-[0_0_30px_rgba(0,0,0,0.2)]">
              ...
              <div className="grid gap-5">
                {projects.map((project) => (
                  <div key={project.title} className="overflow-hidden rounded-2xl border border-[#2a2a2a] bg-[#0a0a0a]">
                    <img
                      src={project.image}
                      alt={project.title}
                    ...
                    <div className="p-5">
                      <h4 className="mb-2 font-mono text-[11px] uppercase tracking-[0.24em] text-[#e4e4e4]">
                        {project.title}
                      </h4>
                      ...
                      <a
                        href={project.pdf}
                        download
                        className="inline-flex items-center gap-2 font-mono text-[11px] uppercase tracking-[0.24em] text-[#fbbf24] transition hover:text-amber-300"
                      >
